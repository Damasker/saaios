...
**Визуальная реализация:** внешний вид, типографика, цвет, компоненты и план
поэтапной миграции определены отдельно в
[SaaiOS Visual Language v1](visual-language-v1.md) и
[Visual System delivery roadmap](../sprints/VISUAL-ROADMAP.md). Этот документ
остаётся источником истины для сущностей, поведения и ментальной модели.
