...
| MEM-08 | Manual review surface without AI | legal read **host** (ADR-264); chrome **host** (ADR-268); Restricted omit ADR-304; panther `4dc19018…` ADR-308 | **yes** (JSONL still forbidden) |
