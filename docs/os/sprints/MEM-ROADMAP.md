...
| MEM-08 | Manual review surface without AI | legal read **host** (ADR-264); chrome **host** (ADR-268); Restricted omit ADR-304; panther paint waits | **yes** (next shell experiment; JSONL still forbidden) |
