...
| S26 | Удалённое выполнение команд по сети | Backlog | `file-recv` (ADR-073) |
| S27 | Заряд устройства не работает под SaaiOS | Backlog | -- |
| S28 | Sandbox-совместимость сторонних приложений | Backlog | S07, ADR-072 |
| S29 | Клавиатура: цифры и символы | Backlog | ADR-029, ADR-065 |
| S30 | Уведомления от сторонних приложений | Backlog | S21 |
| S31 | `file-recv`: скачивание с устройства | Backlog | ADR-073 |
| S32 | Таймер бездействия не видит активность в чужих окнах | Backlog | S11, ADR-072 |
