...
surface, Object View, apps grid, Inbox header, Spaces header, Система header и consent header на panther). VUI-02 остаётся почти закрытым (шрифты в boot-image —
