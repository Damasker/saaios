...
`EventRow`, Spaces list, Wi-Fi list, Bluetooth list и trusted clients
на panther; Wi-Fi password host ADR-132). VUI-02 остаётся почти закрытым (шрифты в boot-image —
