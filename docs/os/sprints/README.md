...
дублировали бы уже единственный источник риск-классификации. Дальше --
Change 2: минимальный вертикальный срез (свободный Intent -> предложение от
уже работающей модели -> Action, видимый в `Сейчас`); расписания/триггеры и
