...
| S24 | PIN/защита экрана блокировки | Реализовано, проверка отложена (приоритетная) | S04 |
| S25 | Доступность (размер шрифта, контраст) | Реализовано, проверка отложена | S13 |
