...
APP-04  экранная клавиатура -- Keyboard→IME (ADR-270 host); GTK 4.18 Entry v3 (ADR-322); Qt 5.15 v2 enable when QT_IM_MODULE unset (ADR-323); panther field not typed
