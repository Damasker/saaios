...
APP-04  экранная клавиатура -- Keyboard→IME (ADR-270 host); GTK 4.18 Entry v3 (ADR-322); Qt 5.15 v2 enable (ADR-323); IME commit_string forwarded, Qt does not repaint (ADR-324); panther field not typed
