...
APP-06  браузер -- Falkon host qemu ADR-306; panther appd hello-frame ADR-312; loopback ADR-313; swrast packed ADR-314; procfs/shm ADR-315 (renderer SIGTRAP, page still white)
