...
| VUI-09 | `.sui` v2, public library, legacy cleanup, and release gate | In progress (ADR-180–198; `compile()` stays v1; not Visual v1 sign-off) |
...
status/keys `Label`/`Caption` (ADR-198).
Release
