...
| Work Scheduler v2 | 121 | DAG + derived ready set в `saai-taskd` | ADR-233 live; ADR-234 boot; ADR-235 follows selection |
...
the watch (ADR-235, `2d3224af…`). WORK-02 всё ещё host-only.
