...
Status: **active sequence after ADR-118…130.**
...
| Visual | 111–116, 126–130 | VUI-00…06 on panther; VUI-07 EventRow Inbox **на panther** (`c1547c02…`); VUI-07 Spaces list **на panther** (`9bb75db5…`); VUI-07 Wi-Fi list **на panther** (`c80bb666…`); VUI-07 Bluetooth list **host** (ADR-130) | **saai-shell `c80bb666…` прошит**; Bluetooth list not flashed |
...
| VUI-07 Bluetooth | live `BluetoothRow` list **host** (ADR-130); not flashed |
