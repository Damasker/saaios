...
Status: **active sequence after ADR-118…142.**
...
| VUI-07 remote pairing header | `ContextHeader` + live client DataRow **host-green, panther hash follows flash** |
