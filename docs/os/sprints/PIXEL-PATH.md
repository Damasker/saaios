...
Status: **active sequence after ADR-118…148.**
...
| VUI-07 lock attention | compact lock-state `StatusIndicator` **на panther** (`55f7bd25…`; PIN currently set so idle gated) |
