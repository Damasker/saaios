...
| Work Scheduler v2 | 121 | DAG + derived ready set в `saai-taskd` | ADR-233 live intents; ADR-234 boot start |
...
Work intent больше не остаётся без Task. WORK-02 всё ещё host-only.
