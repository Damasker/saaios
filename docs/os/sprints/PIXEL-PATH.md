...
- APP-COMPAT APP-02 compositor half: `wp-fractional-scale-v1` + `wp-viewporter` (ADR-266; GDK shm size ADR-286; host GTK4 cairo frame ADR-305; panther displayd `02c78f9f…` pid 6886 ADR-309). Alpine 4.14.4 `gtk4-demo` still SIGSEGV before toplevel.
