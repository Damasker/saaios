...
- WORK-03 Verifying: Result is not Done; Fresh Observation is (ADR-259; shell chrome ADR-295; Result screen ADR-301; Orb Complete ADR-302; host; no shell/taskd flash)
...
- APP-COMPAT APP-06 first browser is Falkon/QtWebEngine (ADR-269; package tree ADR-281; host). No panther launch.
