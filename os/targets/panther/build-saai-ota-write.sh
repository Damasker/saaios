...
# Cross-compile S12 Change 4's partition-write tool for the persistent
# SaaiOS system directory on /data, same as saai-taskd/saai-ota-stage --
...
# "prove it before wiring boot-critical init"). This tool can write real
# boot partitions -- treat every real invocation with the same care as
...
binary="$repo_root/target/aarch64-unknown-linux-musl/pixel7/saai-ota-write"
printf '%s\n' "$binary"
sha256sum "$binary"
